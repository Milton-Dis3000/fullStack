                    ...
                    <table id="example" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $row) {
                                ...
                                echo "<th class='text-sm text-gray-500'>" . $row["usuario"] . "</th>";
                                echo "<th class='text-sm text-gray-500'>" . $row["clave"] . "</th>";
                                echo "<th class='text-sm text-gray-500'>" . $row["habilitado"] . "</th>";
                                echo "<th class='text-sm text-gray-500'>" . $row["fecha"] . "</th>";
                                echo "<th class='text-sm text-gray-500'>" . $row["id_persona"] . "</th>";
                                echo "<th class='text-sm text-gray-500'>" . $row["id_rol"] . "</th>";

                                echo "<th class='flex items-center'>
                                <a href='edit_usuario.php?id=" . $row['id'] . "'>
                                ...
                                <form method='POST' action='http://127.0.0.1:8000/api/usuarios/" . $row['id'] . "' onsubmit='return confirm(\"¿Estás seguro de que quieres eliminar este usuario?\");'>
