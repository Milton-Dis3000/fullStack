                    ...
                    <table id="example" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $row) {
                                ...
                                echo "<th class='text-sm text-gray-500'>" . $row["rol"] . "</th>";

                                echo "<th class='flex items-center'>
                                <a href='edit_roles.php?id=" . $row['id'] . "'>
                                ...
                                <form method='POST' action='http://127.0.0.1:8000/api/rols/" . $row['id'] . "' onsubmit='return confirm(\"¿Estás seguro de que quieres eliminar este rol?\");'>
