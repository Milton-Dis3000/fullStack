...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-11/12 sm:w-5/6 md:w-2/3 lg:w-1/2 xl:w-1/3 p-3 bg-white shadow-md rounded-lg">
        ...
        <form method="POST" action="http://127.0.0.1:8000/api/enlaces/<?php echo $id_enlace; ?>">
            ...
            <input type="hidden" name="id_enlace" value="<?= $_GET["id"] ?>">

            <label for="pagina" class="form-label">Número Página*</label>
            ...
            <label for="rol" class="form-label">Número Rol*</label>
